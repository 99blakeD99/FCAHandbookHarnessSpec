...
An embedding model converts 'chunks' of text into a vector (a fixed-size list of numbers representing position in multi-dimensional space). For example, Voyage 3-large produces 1024-dimensional vectors.
